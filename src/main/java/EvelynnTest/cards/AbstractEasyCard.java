...
import EvelynnTest.util.CardArtRoller;

import java.util.ArrayList;

import static EvelynnTest.EvelynnTestMod.*;
import static EvelynnTest.util.Wiz.atb;
import static EvelynnTest.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, EvelynnTestChar.Enums.EVELYNN_TEST_COLOR);
    }
