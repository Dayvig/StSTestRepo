...
import static EvelynnTest.EvelynnTestChar.Enums.EVELYNN_TEST_COLOR;
import static EvelynnTest.EvelynnTestMod.*;

public class EvelynnTestChar extends CustomPlayer {
    ...
    static final String ID = makeID("EvelynnTestMod"); //TODO: Change this
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public EvelynnTestChar(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new EvelynnTestChar(name, chosenClass);
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass EVELYNN_TEST;
        @SpireEnum(name = "EVELYNN_TEST_COLOR")
        public static AbstractCard.CardColor EVELYNN_TEST_COLOR;
        @SpireEnum(name = "EVELYNN_TEST_COLOR")
